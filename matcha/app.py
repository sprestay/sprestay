...
with app.app_context():
    ...
    confirm VARCHAR(75), password VARCHAR(100) NOT NULL, gender ENUM('m', 'w'), birth DATE, orient ENUM('hetero','bi','homo'), bio TEXT, X float, Y float, manually BOOLEAN DEFAULT false, last_seen DATETIME, fame INT DEFAULT 0)")
